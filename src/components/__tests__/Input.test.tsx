...
describe('Input Component', () => {
  ...
  it('should render label when provided', () => {
    const { getByTestId } = render(<Input {...defaultProps} label="Email" testID="email-input" />);
  ...
  it('should call onFocus when focused', () => {
    ...
    const { getByPlaceholderText } = render(<Input {...defaultProps} onFocus={mockOnFocus} />);
  ...
  it('should call onBlur when blurred', () => {
    ...
    const { getByPlaceholderText } = render(<Input {...defaultProps} onBlur={mockOnBlur} />);
  ...
  describe('Password functionality', () => {
    it('should render password input with eye icon', () => {
      const { getByTestId } = render(<Input {...defaultProps} isPassword testID="password" />);
  ...
  describe('Icons', () => {
    ...
    it('should render right icon when provided', () => {
      const { getByTestId } = render(<Input {...defaultProps} rightIcon="search" testID="input" />);
  ...
  describe('Variants', () => {
    ...
    it('should apply outlined variant styles', () => {
      const { getByPlaceholderText } = render(<Input {...defaultProps} variant="outlined" />);

      expect(getByPlaceholderText('Enter text')).toBeTruthy();
    });

    it('should apply filled variant styles', () => {
      const { getByPlaceholderText } = render(<Input {...defaultProps} variant="filled" />);
  ...
  describe('Sizes', () => {
    it('should apply small size', () => {
      const { getByPlaceholderText } = render(<Input {...defaultProps} size="small" />);

      expect(getByPlaceholderText('Enter text')).toBeTruthy();
    });

    it('should apply medium size', () => {
      const { getByPlaceholderText } = render(<Input {...defaultProps} size="medium" />);

      expect(getByPlaceholderText('Enter text')).toBeTruthy();
    });

    it('should apply large size', () => {
      const { getByPlaceholderText } = render(<Input {...defaultProps} size="large" />);
  ...
  it('should render with testID when provided', () => {
    const { getByTestId } = render(<Input {...defaultProps} testID="test-input" />);
